...
export default function GameCard({game}){
    ...
    return(
	<>
	    <li style={ {width: '30%',minWidth: '25%', height:'auto',padding: '10px', backgroundColor: theme==='dark'?'#333':'purple', display: 'flex', justifyContent: 'center', alignItems: 'center', borderRadius: '20px', transition: 'ease-in-out 500ms'}}> 
